                ...
                <form class="content-form " method="post" action="{{ route('sales.update', ['sale' => $sale]) }}">
                    ...
                    <div class="form-group form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="costs" class="form-control material" onkeyup="setval();" value="{{ $sale->costs }}" id="costs" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="profit" class="col-sm-2 control-label">Total Profit</label>
                            <div class="col-sm-10">
                                <input type="number" name="profit" class="form-control material" id="profit" value="{{ $sale->profit }}" readonly>
                            </div>
                        </div>
