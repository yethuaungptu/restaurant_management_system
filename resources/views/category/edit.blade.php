    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="content-box big-box box-shadow">
                ...
                <form class="content-form " action="{{ route('category.update', ['category' => $category]) }}" method="post">
                    @method('PATCH')
                    @csrf
                    <div class="form-group col-md-12">
                        ...
                        <button type="submit" class="btn btn-success text-uppercase waves">Update</button>
                    </div>
                </form>
            </div>
        </div>
